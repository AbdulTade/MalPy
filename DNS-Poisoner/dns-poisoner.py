...
parser.add_argument("-i","--ip",required=False,help="The ip address you want to redirected to")
parser.add_argument("-u","--url",required=False,help="Url to be redirected from")
